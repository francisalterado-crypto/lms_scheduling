...
$topbarIcon = app_sidebar_topbar_icon_class($navRole);
?>
<div class="admin-layout d-flex min-vh-100 w-100">
    <aside class="admin-sidebar d-none d-lg-flex flex-column flex-shrink-0 no-print" aria-label="Main navigation">
        ...
        <div class="admin-sidebar-footer">
            <a class="admin-sidebar-foot-link" href="settings.php"<?= $appCursorTooltips ? app_tooltip_attr('Opens account settings where you can change your password. Same as Settings in the top menu.') : '' ?>><i class="fa-solid fa-gear me-2 opacity-75" aria-hidden="true"></i>Settings</a>
    ...
    <div class="offcanvas offcanvas-start d-lg-none admin-offcanvas-nav no-print" tabindex="-1" id="adminNavOffcanvas" aria-labelledby="adminNavOffcanvasLabel">
        ...
        <div class="offcanvas-body p-0 d-flex flex-column">
            ...
            <div class="admin-sidebar-footer border-top px-3 py-3 mt-auto">
                <a class="admin-sidebar-foot-link d-block py-1" href="settings.php" data-bs-dismiss="offcanvas"<?= $appCursorTooltips ? app_tooltip_attr('Opens account settings where you can change your password. The mobile menu closes when you tap this.') : '' ?>><i class="fa-solid fa-gear me-2 opacity-75" aria-hidden="true"></i>Settings</a>
    ...
    <div class="admin-main-wrap flex-grow-1 d-flex flex-column min-vh-100 min-w-0">
        <header class="admin-topbar border-bottom bg-white shadow-sm sticky-top no-print">
            <div class="d-flex align-items-center gap-3 px-3 px-lg-4 py-2 py-lg-3">
                ...
                <div class="dropdown admin-topbar-user">
                    <button class="btn btn-light border rounded-pill d-flex align-items-center gap-2 py-1 px-2 px-sm-3" type="button" id="adminUserMenuBtn" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true"<?= $appCursorTooltips ? app_tooltip_attr('Opens your account menu for Settings and Logout. Use this to change your password or sign out when you are done.') : '' ?>>
                        <span class="admin-topbar-avatar rounded-circle d-inline-flex align-items-center justify-content-center"><i class="fa-solid <?= htmlspecialchars($topbarIcon, ENT_QUOTES, 'UTF-8') ?> text-primary" aria-hidden="true"></i></span>
