...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        exec_safe($pdo, "ALTER TABLE users MODIFY role ENUM('admin','dean','program_chair','faculty','gened','student') NOT NULL DEFAULT 'faculty'");
        ...
        exec_safe($pdo, "ALTER TABLE classroom_assessments MODIFY COLUMN assessment_type ENUM('written_work','performance_task','assignment','quiz') NOT NULL DEFAULT 'written_work'");
