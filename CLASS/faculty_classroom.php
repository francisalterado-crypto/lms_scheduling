                ...
                <div class="card-body p-4">
                    <form method="post" enctype="multipart/form-data" id="fc-add-content-form">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 pt-1">
                            <button type="submit" class="btn btn-primary fc-btn-primary-lg"<?= app_tooltip_attr('Publishes this post, files, and links to the class stream for enrolled students.') ?>><i class="fa-solid fa-paper-plane me-2"></i>Publish to class</button>
