            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-4 text-lg-end">
                    <div class="hero-seal-wrap">
                        ...
                        <?php else: ?>
                            <span class="hero-seal-fallback"><i class="fa-solid fa-building-columns"></i></span>
                        <?php endif; ?>
                    </div>
    ...
    <div class="card glass-card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mt-3 d-flex flex-wrap gap-2">
                <a href="faculty_classrooms.php" class="btn btn-primary btn-sm"><i class="fa-solid fa-chalkboard me-1"></i>Open Classrooms</a>
                <a href="faculty_schedule.php" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-calendar-check me-1"></i>Open My Schedule</a>
            </div>
        </div>
    </div>
<?php endif; ?>
...
<?php if ($role === 'student'): ?>
    <div class="card glass-card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mt-3 d-flex flex-wrap gap-2">
                <a href="student_classrooms.php" class="btn btn-primary btn-sm"><i class="fa-solid fa-user-graduate me-1"></i>Open My Classes</a>
                <a href="settings.php" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-key me-1"></i>Change Password</a>
            </div>
        </div>
    </div>
<?php endif; ?>
            ...
            <div class="card-body p-0">
                <?php if (!$showUpcoming): ?>
                    <div class="p-3">
                        ...
                        <a href="student_classrooms.php" class="btn btn-outline-primary btn-sm">Go to My Classes</a>
                    </div>
                <?php elseif (!$upcoming): ?>
        ...
        <div class="card conflict-card">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    ...
                    <a href="conflicts.php" class="btn btn-outline-warning btn-sm">Review conflicts</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
