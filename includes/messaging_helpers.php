...
/** Drop oldest messages in a two-user thread when over the configured FIFO capacity. */
...
/** Active dean user id designated for GE faculty messaging (Francis Alterado by default). */
...
/**
 * Dean, program chair, and GEN ED contacts a faculty member may message in Inbox.
 *
 * @return list<array{id:int,full_name:string,role:string,college_id:?int}>
 */
