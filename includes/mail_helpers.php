...
function account_credentials_role_parts(string $role): array
{
    ...
    $map = [
        ...
        'student_registration' => [
            'subject' => 'Registration approved — WPU SABLAe Portal',
            'role_title' => 'Student',
            'intro' => 'Your registration has been approved by your Program Chair. You can now sign in to WPU SABLAe Portal.',
        ],
    ];
    if (isset($map[$role])) {
        $m = $map[$role];
